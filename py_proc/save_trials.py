...
_TS_FIELDS = [
    ...
    'JoystickTargetOn', 'JoystickFirstMovement',
    'JoystickTargetEntry', 'JoystickTargetEntryFinal',
    'JoystickTargetExit', 'JoystickTargetExitFinal',
    'JoystickHoldStart', 'JoystickHoldStartFinal',
    'JoystickHoldBreak', 'JoystickHoldBreakFinal',
    'JoystickHoldComplete', 'JoystickReward',
...
def _extract_trial(Events, itrial, day, rec):
    ...
    t = {
        ...
        'JoystickTargetOn': _ts('JoystickTargetOn'),
        'JoystickFirstMovement': _ts('JoystickFirstMovement'),
        'JoystickTargetEntry': _ts('JoystickTargetEntry'),
        'JoystickTargetEntryFinal': _ts('JoystickTargetEntryFinal'),
        'JoystickTargetExit': _ts('JoystickTargetExit'),
        'JoystickTargetExitFinal': _ts('JoystickTargetExitFinal'),
        'JoystickHoldStart': _ts('JoystickHoldStart'),
        'JoystickHoldStartFinal': _ts('JoystickHoldStartFinal'),
        'JoystickHoldBreak': _ts('JoystickHoldBreak'),
        'JoystickHoldBreakFinal': _ts('JoystickHoldBreakFinal'),
        'JoystickHoldComplete': _ts('JoystickHoldComplete'),
        'JoystickReward': _ts('JoystickReward'),
        ...
        'JoystickAttemptCount': float(_scalar(Events.get('JoystickAttemptCount', [np.nan]), itrial, np.nan)),
